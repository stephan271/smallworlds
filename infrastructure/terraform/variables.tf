...
variable "location" {
  description = "Hetzner location for the server and data volume. The Primary IP must be created in the same location. e.g. hel1 (Helsinki), nbg1 (Nuremberg), fsn1 (Falkenstein)."
  type        = string
  default     = "hel1"
}
