...
- `[x]` means a **first implementation exists in this repository**. It is not a claim that the capability is production-ready, fully documented, or complete.
- `[ ]` means no initial implementation exists yet.
...
### Video Conferencing
- [x] An initial Jitsi Meet integration exists.
...
- [x] An initial Excalidraw integration exists.
- **Target:** **Excalidraw**
...
- [x] An initial Plane integration exists.
...
### Local installation
- [ ] Support installation on a home server or other on-premises hardware, without requiring Hetzner Cloud APIs or infrastructure.

### Other cloud providers
- [ ] Support providers beyond Hetzner Cloud, beginning with provider-specific infrastructure, DNS, storage, and bootstrap modules.
...
- [x] An initial implementation exists: scheduled CNPG backups to Garage S3, Velero cluster backups, and the backup-replicator job.
...
- [x] An initial Argo CD and Kustomize-based implementation exists.
...
- [x] An initial Prometheus, Alertmanager, Loki, and Grafana stack exists.
...
- [x] An initial implementation exists through the staging/E2E runner and Renovate pull-request automation.
...
- [x] An initial Hermes agent implementation exists with observability and cluster integrations.
...
- [x] An initial remediation and escalation implementation exists; fully autonomous lifecycle management remains future work.
