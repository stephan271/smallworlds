...
Both workflows sign with the repository secret `SMALLWORLDS_RELEASE_ED25519_PRIVATE_KEY_B64`. See [`docs/releases/github-release-signing-setup.md`](docs/releases/github-release-signing-setup.md).
...
Commit and push this **before** tagging. See [`docs/releases/bootstrap-inputs/README.md`](docs/releases/bootstrap-inputs/README.md).
